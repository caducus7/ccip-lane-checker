...
var init_errors = __esm(() => {
  BaseError2 = class BaseError22 extends Error {
    constructor(shortMessage, args = {}) {
      ...
      const docsPath = args.cause instanceof BaseError22 ? args.cause.docsPath || args.docsPath : args.docsPath;
      const message = [
        shortMessage || "An error occurred.",
        "",
        ...args.metaMessages ? [...args.metaMessages, ""] : [],
...
var init_base2 = __esm(() => {
  ...
  BaseError3 = class BaseError32 extends Error {
    constructor(shortMessage, args = {}) {
      const details = (() => {
        if (args.cause instanceof BaseError32)
          return args.cause.details;
        if (args.cause?.message)
          return args.cause.message;
        return args.details;
...
var init_abi = __esm(() => {
  ...
  init_size2();
  init_base2();
  AbiDecodingDataSizeTooSmallError = class AbiDecodingDataSizeTooSmallError2 extends BaseError3 {
...
`), {
  ...
  AbiDecodingZeroDataError = class AbiDecodingZeroDataError2 extends BaseError3 {
    constructor({ cause } = {}) {
  ...
  AbiEncodingArrayLengthMismatchError = class AbiEncodingArrayLengthMismatchError2 extends BaseError3 {
...
`), { name: "AbiEncodingArrayLengthMismatchError" });
  ...
  AbiEncodingBytesSizeMismatchError = class AbiEncodingBytesSizeMismatchError2 extends BaseError3 {
    constructor({ expectedSize, value: value2 }) {
      super(`Size of bytes "${value2}" (bytes${size2(value2)}) does not match expected size (bytes${expectedSize}).`, { name: "AbiEncodingBytesSizeMismatchError" });
    }
  };
  AbiEncodingLengthMismatchError = class AbiEncodingLengthMismatchError2 extends BaseError3 {
...
`), { name: "AbiEncodingLengthMismatchError" });
  ...
  AbiEventSignatureEmptyTopicsError = class AbiEventSignatureEmptyTopicsError2 extends BaseError3 {
  ...
  AbiEventSignatureNotFoundError = class AbiEventSignatureNotFoundError2 extends BaseError3 {
...
`), {
  ...
  AbiFunctionNotFoundError = class AbiFunctionNotFoundError2 extends BaseError3 {
...
`), {
  ...
  AbiFunctionOutputsNotFoundError = class AbiFunctionOutputsNotFoundError2 extends BaseError3 {
    constructor(functionName, { docsPath }) {
      super([
...
`), {
  ...
  AbiItemAmbiguityError = class AbiItemAmbiguityError2 extends BaseError3 {
    constructor(x, y) {
  ...
  DecodeLogDataMismatch = class DecodeLogDataMismatch2 extends BaseError3 {
...
`), {
  ...
  DecodeLogTopicsMismatch = class DecodeLogTopicsMismatch2 extends BaseError3 {
...
`), { name: "DecodeLogTopicsMismatch" });
  ...
  InvalidAbiEncodingTypeError = class InvalidAbiEncodingTypeError2 extends BaseError3 {
...
`), { docsPath, name: "InvalidAbiEncodingType" });
  ...
  InvalidAbiDecodingTypeError = class InvalidAbiDecodingTypeError2 extends BaseError3 {
    constructor(type, { docsPath }) {
      super([
...
`), { docsPath, name: "InvalidAbiDecodingType" });
  ...
  InvalidArrayError = class InvalidArrayError2 extends BaseError3 {
    constructor(value2) {
...
`), {
  ...
  InvalidDefinitionTypeError = class InvalidDefinitionTypeError2 extends BaseError3 {
    constructor(type) {
      super([
...
var init_data2 = __esm(() => {
  init_base2();
  SliceOffsetOutOfBoundsError = class SliceOffsetOutOfBoundsError2 extends BaseError3 {
...
var init_encoding2 = __esm(() => {
  ...
  InvalidBytesBooleanError = class InvalidBytesBooleanError2 extends BaseError3 {
    constructor(bytes) {
...
function assertSize3(hexOrBytes, { size: size3 }) {
...
function hexToBigInt2(hex, opts = {}) {
  ...
  if (value2 <= max)
    return value2;
  return value2 - BigInt(`0x${"f".padStart(size3 * 2, "f")}`) - 1n;
}
...
function numberToHex2(value_, opts = {}) {
  ...
  const hex = `0x${(signed && value2 < 0 ? (1n << BigInt(size3 * 8)) + BigInt(value2) : value2).toString(16)}`;
  if (size3)
...
function keccak2562(value2, to_) {
  const to = to_ || "hex";
  const bytes = keccak_2562(isHex2(value2, { strict: false }) ? toBytes3(value2) : value2);
  if (to === "bytes")
    return bytes;
  return toHex2(bytes);
}
...
var init_address2 = __esm(() => {
  init_base2();
  InvalidAddressError2 = class InvalidAddressError22 extends BaseError3 {
...
var LruMap2;
var init_lru2 = __esm(() => {
  LruMap2 = class LruMap22 extends Map {
    constructor(size3) {
      super();
      Object.defineProperty(this, "maxSize", {
        enumerable: true,
...
function assertStartOffset(value2, start) {
  if (typeof start === "number" && start > 0 && start > size2(value2) - 1)
...
function assertEndOffset(value2, start, end) {
  if (typeof start === "number" && typeof end === "number" && size2(value2) !== end - start) {
    throw new SliceOffsetOutOfBoundsError({
      offset: end,
      position: "end",
      size: size2(value2)
...
function encodeAddress(value2) {
  if (!isAddress2(value2))
    throw new InvalidAddressError2({ address: value2 });
  return { dynamic: false, encoded: padHex2(value2.toLowerCase()) };
}
...
var init_cursor = __esm(() => {
  init_base2();
  NegativeOffsetError = class NegativeOffsetError2 extends BaseError3 {
    constructor({ offset }) {
  ...
  PositionOutOfBoundsError = class PositionOutOfBoundsError2 extends BaseError3 {
    constructor({ length, position }) {
      super(`Position \`${position}\` is out of bounds (\`0 < position < ${length}\`).`, { name: "PositionOutOfBoundsError" });
    }
  };
  RecursiveReadLimitExceededError = class RecursiveReadLimitExceededError2 extends BaseError3 {
...
function decodeAddress(cursor) {
  ...
  return [checksumAddress2(bytesToHex4(sliceBytes(value2, -20))), 32];
}
...
function decodeBytes(cursor, param, { staticPosition }) {
  ...
  const value2 = bytesToHex4(cursor.readBytes(Number.parseInt(size3, 10), 32));
  return [value2, 32];
}
...
function read(buffer, offset, isLE22, mLen, nBytes) {
  var e, m, eLen = nBytes * 8 - mLen - 1, eMax = (1 << eLen) - 1, eBias = eMax >> 1, nBits = -7, i2 = isLE22 ? nBytes - 1 : 0, d = isLE22 ? -1 : 1, s = buffer[offset + i2];
...
function write(buffer, value, offset, isLE22, mLen, nBytes) {
  var e, m, c, eLen = nBytes * 8 - mLen - 1, eMax = (1 << eLen) - 1, eBias = eMax >> 1, rt = mLen === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, i2 = isLE22 ? 0 : nBytes - 1, d = isLE22 ? 1 : -1, s = value < 0 || value === 0 && 1 / value < 0 ? 1 : 0;
...
function assertSize2(size22) {
  if (typeof size22 !== "number")
    throw new TypeError('"size" argument must be of type number');
  else if (size22 < 0)
    throw new RangeError('The value "' + size22 + '" is invalid for option "size"');
}
function alloc(size22, fill, encoding) {
  if (assertSize2(size22), size22 <= 0)
    return createBuffer(size22);
  if (fill !== undefined)
    return typeof encoding === "string" ? createBuffer(size22).fill(fill, encoding) : createBuffer(size22).fill(fill);
  return createBuffer(size22);
}
Buffer2.alloc = function(size22, fill, encoding) {
  return alloc(size22, fill, encoding);
};
function allocUnsafe(size22) {
  return assertSize2(size22), createBuffer(size22 < 0 ? 0 : checked(size22) | 0);
}
Buffer2.allocUnsafe = function(size22) {
  return allocUnsafe(size22);
};
Buffer2.allocUnsafeSlow = function(size22) {
  return allocUnsafe(size22);
};
...
function getEncodedSize(value, encoder32) {
  return "fixedSize" in encoder32 ? encoder32.fixedSize : encoder32.getSizeFromValue(value);
}
function createEncoder(encoder32) {
  return Object.freeze({
    ...encoder32,
    encode: (value) => {
      const bytes = new Uint8Array(getEncodedSize(value, encoder32));
      encoder32.write(value, bytes, 0);
      return bytes;
    }
  });
}
...
function fixEncoderSize(encoder32, fixedBytes) {
  return createEncoder({
    fixedSize: fixedBytes,
    write: (value, bytes, offset) => {
      const variableByteArray = encoder32.encode(value);
...
function transformEncoder(encoder32, unmap) {
  return createEncoder({
    ...isVariableSize(encoder32) ? { ...encoder32, getSizeFromValue: (value) => encoder32.getSizeFromValue(unmap(value)) } : encoder32,
    write: (value, bytes, offset) => encoder32.write(unmap(value), bytes, offset)
  });
}
...
class ZodSet extends ZodType {
  ...
  size(size22, message) {
    return this.min(size22, message).max(size22, message);
  }
  nonempty(message) {
    return this.min(1, message);
  }
...
init_toBytes2();
init_keccak2562();
var laneControllerAbi = parseAbi([
...
var resolveChainSelector = (config) => {
  ...
  const selector = ClientCapability.SUPPORTED_CHAIN_SELECTORS[name];
  if (selector === undefined) {
    throw new Error(`Unsupported chain selector name: ${name}`);
  }
  return selector;
};
function writeLaneController(runtime2, evmClient, abi, functionName, args) {
  ...
  const gasLimit = runtime2.config.gasLimit ?? "800000";
  const txResult = evmClient.writeReport(runtime2, {
    receiver: runtime2.config.laneControllerAddress,
    report: report2,
    gasConfig: { gasLimit }
  }).result();
  const txHash = txResult.txHash ? bytesToHex3(txResult.txHash) : "pending";
  runtime2.log(`writeReport ${functionName} tx=${txHash} status=${txResult.txStatus}`);
  return txHash;
}
function createEvmClient(config) {
  return new ClientCapability(resolveChainSelector(config));
}
function controllerAddress(config) {
  return config.laneControllerAddress;
}
var HOP_COMPLETED_SIG = keccak2562(toBytes3("HopCompleted(uint256,uint8,uint64,uint256,uint8)"));
var LANE_FINISHED_SIG = keccak2562(toBytes3("LaneFinished(uint256,uint8,uint256)"));
var getWinnerLane = (runtime2, roundId) => {
...
var decodeHopCompleted = (log) => {
  const topics = log.topics.map((topic) => bytesToHex3(topic));
...
var onHopCompleted = (runtime2, log) => {
  ...
  const result = {
    ...
    txHash: bytesToHex3(log.txHash)
  };
  runtime2.log(`HopCompleted: ${JSON.stringify(result)}`);
  return JSON.stringify(result);
};
var onLaneFinished = (runtime2, log) => {
  const decoded = decodeLaneFinished(log);
  const { roundId, laneId, finishTime } = decoded.args;
  runtime2.log(`LaneFinished round=${roundId} lane=${laneId} finishTime=${finishTime}`);
  const existingWinner = getWinnerLane(runtime2, roundId);
  if (existingWinner !== 0) {
    const skipped = {
      event: "LaneFinished",
      action: "skipped",
    ...
    runtime2.log(JSON.stringify(skipped));
    return JSON.stringify(skipped);
  }
  const evmClient = createEvmClient(runtime2.config);
  const declareTx = writeLaneController(runtime2, evmClient, laneControllerAbi, "declareWinner", [roundId, laneId]);
  const result = {
    event: "LaneFinished",
  ...
  runtime2.log(`First finisher — winner declared: ${JSON.stringify(result)}`);
  return JSON.stringify(result);
};
var chainSelector = (name) => {
  const selector = cre.capabilities.EVMClient.SUPPORTED_CHAIN_SELECTORS[name];
  if (selector === undefined) {
...
var initWorkflow = (config) => {
  const handlers = [];
  const controller = config.laneControllerAddress;
  for (const chain of config.chains) {
    const evmClient = new cre.capabilities.EVMClient(chainSelector(chain.chainSelectorName));
    handlers.push(handler(evmClient.logTrigger(logTriggerConfig({
      addresses: [controller],
      topics: [[HOP_COMPLETED_SIG]]
    })), onHopCompleted), handler(evmClient.logTrigger(logTriggerConfig({
      addresses: [controller],
