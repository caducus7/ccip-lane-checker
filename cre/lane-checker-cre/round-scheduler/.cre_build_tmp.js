...
var toSelectorBigints = (paths) => paths.map((lane) => lane.map((selector) => BigInt(selector)));
var onCronTrigger = (runtime2, payload) => {
  ...
  runtime2.log(`createRound tx=${createTx}, currentRoundId=${roundId}`);
  ...
  runtime2.log(`Round started: ${JSON.stringify(result)}`);
